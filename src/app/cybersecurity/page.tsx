  ...
  const tabs: Tab[] = [
    {
      ...
      content: (
        <div className="space-y-8">
          <div className="bg-white rounded-xl border-l-4 border-cybersecurity-red shadow-sm p-6">
            <h3 className="text-2xl font-bold text-gray-900 mb-1">
              {cyberFair.emoji ? `${cyberFair.emoji} ` : ''}{cyberFair.title}
            </h3>
            <p className="text-cybersecurity-red font-medium text-sm mb-4">{cyberFair.date}</p>
        ...
        <div className="space-y-8">
          <div className="grid md:grid-cols-2 gap-6">
            {projects.map((p) => (
              <div
                key={p.title}
                className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 hover:shadow-md hover:border-cybersecurity-red/30 transition-all duration-200"
              >
