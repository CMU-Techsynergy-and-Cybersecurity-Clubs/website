...
export default function CybersecurityPage() {
  const theme = clubThemes.cybersecurity
  ...
  const tabs: Tab[] = [
    {
      ...
      content: (
        <div className="space-y-8">
          <div className="bg-white dark:bg-gray-900 rounded-xl border-l-4 border-cybersecurity-red shadow-sm p-6">
            <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-1">
              {cyberFair.emoji ? `${cyberFair.emoji} ` : ''}{cyberFair.title}
            </h3>
            <p className="text-cybersecurity-red dark:text-red-400 font-medium text-sm mb-4">{cyberFair.date}</p>
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">{cyberFair.description}</p>
        ...
        <div className="space-y-8">
          <div className="grid md:grid-cols-2 gap-6">
            {projects.map((p) => (
              <div
                key={p.title}
                className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm p-6 hover:shadow-md hover:border-cybersecurity-red/30 transition-all duration-200"
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {p.tags.map((tag) => (
                    <span
                      key={tag}
                      className="bg-cybersecurity-red/10 text-cybersecurity-red text-xs font-semibold px-2.5 py-1 rounded-full"
                    >
                      {tag}
                    </span>
                  ))}
          ...
          <div className="bg-cybersecurity-gold/10 border border-cybersecurity-gold/30 rounded-xl p-5 text-center">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-8">
          ...
          <div className="bg-cybersecurity-dark text-white rounded-xl p-6 text-center">
            <h3 className="text-xl font-bold text-cybersecurity-gold mb-2">Join Us!</h3>
          ...
          {/* <div className="grid lg:grid-cols-[1fr_300px] gap-10"> */}
            <div>
              <div className="mb-10">
                ...
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">{intro}</p>
              </div>
              ...
              <div className="bg-gray-50 rounded-xl border border-gray-100 p-5">
                ...
                <p className="text-sm mb-2">
                  <a
                    ...
                    className="text-cybersecurity-red hover:underline break-all"
                  >
                    {config.email}
                  </a>
                </p>
                <p className="text-sm">
                  <a
                    ...
                    className="text-cybersecurity-red hover:underline font-medium"
                  >
                    Join our Discord →
                  </a>
                </p>
