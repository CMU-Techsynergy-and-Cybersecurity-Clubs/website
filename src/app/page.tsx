...
export default function Home() {
  ...
  return (
    <div>
      {/* ── Hero ── */}
      <section className="relative bg-gradient-to-br from-cybersecurity-dark via-gray-900 to-compsci-purple-dark overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32 text-center">
          ...
          <div className="grid grid-cols-2 gap-6 max-w-2xl mx-auto">
            ...
            <div>
              <div className="text-4xl md:text-5xl font-black text-cybersecurity-gold">Weekly</div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-5">
                  <span className="bg-cybersecurity-red/10 text-cybersecurity-red text-xs font-semibold px-3 py-1 rounded-full">
                    Security Training
                  </span>
                  <span className="bg-cybersecurity-red/10 text-cybersecurity-red text-xs font-semibold px-3 py-1 rounded-full">
                    CTF Competitions
                ...
                <span className="inline-flex items-center text-cybersecurity-red font-semibold group-hover:translate-x-1 transition-transform">
                  Learn More →
                </span>
              </div>
            </Link>
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-5">
                  <span className="bg-compsci-purple/10 text-compsci-purple text-xs font-semibold px-3 py-1 rounded-full">
                    Code Competitions
                  </span>
                  <span className="bg-compsci-purple/10 text-compsci-purple text-xs font-semibold px-3 py-1 rounded-full">
                    Innovation Projects
                ...
                <span className="inline-flex items-center text-compsci-purple font-semibold group-hover:translate-x-1 transition-transform">
                  Learn More →
                </span>
              </div>
            </Link>
