  ...
  const tabs: Tab[] = [
    {
      ...
      content: (
        <div className="space-y-8">
          <div className="bg-white dark:bg-gray-900 rounded-xl border-l-4 border-compsci-purple shadow-sm p-6">
            <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-1">
              {icpc.emoji ? `${icpc.emoji} ` : ''}{icpc.title}
            </h3>
            <p className="text-compsci-purple dark:text-purple-400 font-medium text-sm mb-4">{icpc.date}</p>
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">{icpc.description}</p>
        ...
        <div className="space-y-8">
          <div className="grid md:grid-cols-2 gap-6">
            {projects.map((p) => (
              <div
                key={p.title}
                className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm p-6 hover:shadow-md hover:border-compsci-purple/30 transition-all duration-200"
              >
