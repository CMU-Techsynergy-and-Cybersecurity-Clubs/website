...
- `src/components/club/` — `MotionClubPage` (club page in the motion design) and `ClubPageSwitch`, which falls back to the classic `ClubPage` when the layout toggle is set to classic
